...
class Contact extends Component{
    ...
    //If there is a change in an input field then save the state
    ...
    handleSubmit(event) {
        ...
        //Prevent change to another page after submitting
        event.preventDefault();
    }

    //Says if one of the fields has been touched
    ...
    //Checks if the input fields applies by the rules
